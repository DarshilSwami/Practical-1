class Matrix(private val matrix: Array<IntArray>, private val rows: Int,
...
fun main() {
    val firstMatrix = Matrix(arrayOf(intArrayOf(3, 2, 6), intArrayOf(3, 0,
        9)), 2, 3)
    val secondMatrix1 = Matrix(arrayOf(intArrayOf(2, 3), intArrayOf(-9,
        0), intArrayOf(0, 6)), 3, 2)
    val secondMatrix2 = Matrix(arrayOf(intArrayOf(6, 3), intArrayOf(9,
        0), intArrayOf(2, 5)), 3, 2)
    println("================== Addition ==================")
            println("Matrix 1 : ")
